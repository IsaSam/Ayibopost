...
//  iOS_Ayibopost
//
//  Created by Isaac Samuel on 2/14/19.
//  Copyright © 2019 Isaac Samuel. All rights reserved.
//

import UIKit

class AyiboFanm: UIViewController, UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate {
